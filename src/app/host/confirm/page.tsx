...
export default function HostConfirmPage() {
  return (
    <Suspense
      fallback={<main className="min-h-screen bg-yellow-50 p-6 text-gray-700">Loading…</main>}
    >
      <HostConfirmInner />
    </Suspense>
  );
    ...
    <main className="min-h-screen bg-yellow-50">
      <div className="mx-auto max-w-3xl p-6">
        ...
        <p className="text-gray-700 mb-6">
          Share this code with your group. When ready, join the session to load restaurants that
          match the chosen price and radius.
        </p>

        <div className="rounded-2xl bg-white border p-6 shadow-sm">
          <div className="text-sm text-gray-600 mb-2">Code</div>
          <div className="text-5xl font-black tracking-widest mb-6">{code ?? '----'}</div>
